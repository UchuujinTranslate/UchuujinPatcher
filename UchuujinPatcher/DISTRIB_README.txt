Nichijou: Uchuujin English Translation patch

INSTRUCTIONS:
Unzip this .zip file.

Open up DeltaPatcherLite.exe and select the original iso and xdelta patch. 
(Important you are giving it the original .iso file, cannot use previous patched versions!)
...
Alternative way to apply the xdelta patch: https://www.romhacking.net/patch/ 
